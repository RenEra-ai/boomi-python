...
class AtomSecurityPoliciesService(BaseService):
    ...
    def update_atom_security_policies(
    ...
    ) -> Union[AtomSecurityPolicies, str, dict]:
        ...
        :rtype: Union[AtomSecurityPolicies, str, dict]
        """
        ...
        return self._deserialize_or_raw(AtomSecurityPolicies, response, status, content)
    ...
    def async_token_atom_security_policies(
        self, token: str
    ) -> Union[AtomSecurityPoliciesAsyncResponse, str, dict]:
        ...
        ...
        :return: The parsed response data.
        :rtype: Union[AtomSecurityPoliciesAsyncResponse, str, dict]
        """
        ...
        response, status, content = self.send_request(serialized_request)
        return self._deserialize_or_raw(AtomSecurityPoliciesAsyncResponse, response, status, content)
