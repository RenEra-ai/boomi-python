...
class RosettaNetConnectorRecordService(BaseService):
    ...
    def query_rosetta_net_connector_record(
    ...
    ) -> Union[RosettaNetConnectorRecordQueryResponse, str, dict]:
        ...
        :rtype: Union[RosettaNetConnectorRecordQueryResponse, str, dict]
        """
        ...
        return self._deserialize_or_raw(RosettaNetConnectorRecordQueryResponse, response, status, content)
