...
class As2ConnectorRecordService(BaseService):
    ...
    def query_as2_connector_record(
        ...
        :type request_body: As2ConnectorRecordQueryConfig, optional
        ...
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/AS2ConnectorRecord/query",
        ...
        return self._deserialize_or_raw(As2ConnectorRecordQueryResponse, response, status, content)
    ...
    def query_more_as2_connector_record(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/AS2ConnectorRecord/queryMore",
                [self.get_access_token(), self.get_basic_auth()],
            )
            .serialize()
            .set_method("POST")
