...
class AccountCloudAttachmentPropertiesService(BaseService):
    ...
    def update_account_cloud_attachment_properties(
    ...
    ) -> Union[AccountCloudAttachmentProperties, str, dict]:
        ...
        :rtype: Union[AccountCloudAttachmentProperties, str, dict]
        """
        ...
        return self._deserialize_or_raw(AccountCloudAttachmentProperties, response, status, content)
    ...
    def async_get_account_cloud_attachment_properties(
        ...
        response, status, content = self.send_request(serialized_request)
        result = self._deserialize_or_raw(
            AsyncOperationTokenResult, response, status, content
        )
    ...
    def async_token_account_cloud_attachment_properties(
        self, token: str
    ) -> Union[AccountCloudAttachmentPropertiesAsyncResponse, str, dict]:
        ...
        ...
        :return: The parsed response data.
        :rtype: Union[AccountCloudAttachmentPropertiesAsyncResponse, str, dict]
        """
        ...
        response, status, content = self.send_request(serialized_request)
        result = self._deserialize_or_raw(
            AccountCloudAttachmentPropertiesAsyncResponse, response, status, content
        )
