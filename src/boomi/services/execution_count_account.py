...
class ExecutionCountAccountService(BaseService):
    ...
    def query_execution_count_account(
    ...
    ) -> Union[ExecutionCountAccountQueryResponse, str, dict]:
        ...
        :rtype: Union[ExecutionCountAccountQueryResponse, str, dict]
        """
        ...
        return self._deserialize_or_raw(ExecutionCountAccountQueryResponse, response, status, content)
