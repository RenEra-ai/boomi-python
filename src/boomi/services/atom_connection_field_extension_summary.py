...
class AtomConnectionFieldExtensionSummaryService(BaseService):

    @cast_models
    def query_atom_connection_field_extension_summary(
        self, request_body: AtomConnectionFieldExtensionSummaryQueryConfig = None
    ) -> Union[AtomConnectionFieldExtensionSummaryQueryResponse, str, dict]:
        ...
        :type request_body: AtomConnectionFieldExtensionSummaryQueryConfig, optional
        ...
        :raises RequestError: Raised when a request fails, with optional HTTP status code and details.
        ...
        :return: The parsed response data.
        :rtype: Union[AtomConnectionFieldExtensionSummaryQueryResponse, str, dict]
        """
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/AtomConnectionFieldExtensionSummary/query",
        ...
        return self._deserialize_or_raw(
            AtomConnectionFieldExtensionSummaryQueryResponse, response, status, content
        )
    ...
    def query_more_atom_connection_field_extension_summary(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/AtomConnectionFieldExtensionSummary/queryMore",
                [self.get_access_token(), self.get_basic_auth()],
            )
            .serialize()
            .set_method("POST")
