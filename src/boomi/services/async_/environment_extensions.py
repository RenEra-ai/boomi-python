...
class EnvironmentExtensionsServiceAsync(EnvironmentExtensionsService):
    ...
    def get_environment_extensions(
        self, id_: str
    ) -> Awaitable[Union[EnvironmentExtensions, str, dict]]:
    ...
    ) -> Awaitable[Union[EnvironmentExtensionsBulkResponse, str, dict]]:
    ...
    ) -> Awaitable[Union[EnvironmentExtensionsQueryResponse, str, dict]]:
