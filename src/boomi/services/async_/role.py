...
class RoleServiceAsync(RoleService):
    ...
    def create_role(self, request_body: Role = None) -> Awaitable[Union[Role, str, dict]]:
        return to_async(super().create_role)(request_body)

    def get_role(self, id_: str) -> Awaitable[Union[Role, str, dict]]:
        return to_async(super().get_role)(id_)

    def update_role(
        self, id_: str, request_body: Role = None
    ) -> Awaitable[Union[Role, str, dict]]:
    ...
    ) -> Awaitable[Union[RoleBulkResponse, str, dict]]:
        return to_async(super().bulk_role)(request_body)

    def query_role(
        self, request_body: RoleQueryConfig = None
    ) -> Awaitable[Union[RoleQueryResponse, str, dict]]:
