...
class FolderServiceAsync(FolderService):
    ...
    ) -> Awaitable[Union[Folder, str, dict]]:
        return to_async(super().create_folder)(request_body)

    def get_folder(self, id_: str) -> Awaitable[Union[Folder, str, dict]]:
    ...
    ) -> Awaitable[Union[FolderBulkResponse, str, dict]]:
        return to_async(super().bulk_folder)(request_body)

    def query_folder(
        self, request_body: FolderQueryConfig = None
    ) -> Awaitable[Union[FolderQueryResponse, str, dict]]:
