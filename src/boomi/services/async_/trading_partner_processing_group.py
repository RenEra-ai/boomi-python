...
class TradingPartnerProcessingGroupServiceAsync(TradingPartnerProcessingGroupService):
    ...
    ) -> Awaitable[Union[TradingPartnerProcessingGroup, str, dict]]:
    ...
    ) -> Awaitable[Union[TradingPartnerProcessingGroupBulkResponse, str, dict]]:
    ...
    ) -> Awaitable[Union[TradingPartnerProcessingGroupQueryResponse, str, dict]]:
