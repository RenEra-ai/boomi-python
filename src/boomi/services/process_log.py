...
class ProcessLogService(BaseService):
    ...
    def download_process_log(
        ...
        create_process_log(), then polls the returned URL until the content is ready.
        ...
        :return: The raw log content as bytes (typically a ZIP file).
        :rtype: bytes
        """
        result = self.create_process_log(request_body=request_body)
