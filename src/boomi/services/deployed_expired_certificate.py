...
class DeployedExpiredCertificateService(BaseService):
    ...
    def query_deployed_expired_certificate(
    ...
    ) -> Union[DeployedExpiredCertificateQueryResponse, str, dict]:
        ...
        :rtype: Union[DeployedExpiredCertificateQueryResponse, str, dict]
        """
        ...
        return self._deserialize_or_raw(DeployedExpiredCertificateQueryResponse, response, status, content)
