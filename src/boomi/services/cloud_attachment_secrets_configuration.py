...
class CloudAttachmentSecretsConfigurationService(BaseService):
    ...
    def create_cloud_attachment_secrets_configuration(
    ...
    ) -> Union[CloudAttachmentSecretsConfigurationResponse, str, dict]:
        ...
        :rtype: Union[CloudAttachmentSecretsConfigurationResponse, str, dict]
        """
        ...
        return self._deserialize_or_raw(CloudAttachmentSecretsConfigurationResponse, response, status, content)
