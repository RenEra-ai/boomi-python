...
class ProcessScheduleStatusBulkResponseResponse(BaseModel):
    """ProcessScheduleStatusBulkResponseResponse

    :param result: result, defaults to None
    :type result: ProcessScheduleStatus, optional
    ...
    def __init__(
        self,
        result: ProcessScheduleStatus = SENTINEL,
        index: int = SENTINEL,
        id_: str = SENTINEL,
        ...
        **kwargs,
        ...
        if result is not SENTINEL:
            self.result = self._define_object(result, ProcessScheduleStatus)
...
@JsonMap({})
class ProcessScheduleStatusBulkResponse(BaseModel):
    """ProcessScheduleStatusBulkResponse

    :param response: response, defaults to None
    :type response: List[ProcessScheduleStatusBulkResponseResponse], optional
    """

    def __init__(
        self,
        response: List[ProcessScheduleStatusBulkResponseResponse] = SENTINEL,
        **kwargs,
    ):
        """ProcessScheduleStatusBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(
                response, ProcessScheduleStatusBulkResponseResponse
            )
        self._kwargs = kwargs
