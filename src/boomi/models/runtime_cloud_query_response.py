...
class RuntimeCloudQueryResponse(BaseModel):
    ...
    :type result: List[RuntimeCloud], optional
    """
    ...
    def __init__(
        ...
        result: List[RuntimeCloud] = SENTINEL,
        **kwargs,
    ):
        """RuntimeCloudQueryResponse
        ...
        if result is not SENTINEL:
            self.result = self._define_list(result, RuntimeCloud)
        self._kwargs = kwargs
