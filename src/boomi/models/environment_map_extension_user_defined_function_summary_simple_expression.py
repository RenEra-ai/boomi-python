...
class EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionOperator._member_map_.values(),
            )
        )


class EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpression(BaseModel):
    ...
    :type operator: EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionOperator
    :param property: property
    :type property: EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.operator = self._enum_matching(
            operator,
            EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            EnvironmentMapExtensionUserDefinedFunctionSummarySimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
