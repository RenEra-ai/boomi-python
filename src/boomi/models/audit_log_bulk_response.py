...
class AuditLogBulkResponseResponse(BaseModel):
    """AuditLogBulkResponseResponse

    :param result: result, defaults to None
    :type result: AuditLog, optional
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if result is not SENTINEL:
            self.result = self._define_object(result, AuditLog)
...
class AuditLogBulkResponse(BaseModel):
    ...
    :type response: List[AuditLogBulkResponseResponse], optional
    """

    def __init__(
        self, response: List[AuditLogBulkResponseResponse] = SENTINEL, **kwargs
    ):
        """AuditLogBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(response, AuditLogBulkResponseResponse)
        self._kwargs = kwargs
