...
class PublisherIntegrationPackSimpleExpressionOperator(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                PublisherIntegrationPackSimpleExpressionOperator._member_map_.values(),
            )
        )


class PublisherIntegrationPackSimpleExpressionProperty(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                PublisherIntegrationPackSimpleExpressionProperty._member_map_.values(),
            )
        )


@JsonMap({})
class PublisherIntegrationPackSimpleExpression(BaseModel):
    """PublisherIntegrationPackSimpleExpression

    :param argument: argument, defaults to None
    :type argument: List[str], optional
    :param operator: operator
    :type operator: PublisherIntegrationPackSimpleExpressionOperator
    :param property: property
    :type property: PublisherIntegrationPackSimpleExpressionProperty
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.operator = self._enum_matching(
            operator,
            PublisherIntegrationPackSimpleExpressionOperator.list(),
            "operator",
        )
        self.property = self._enum_matching(
            property,
            PublisherIntegrationPackSimpleExpressionProperty.list(),
            "property",
        )
        self._kwargs = kwargs
