...
from .publisher_integration_pack import PublisherIntegrationPack
...
@JsonMap({})
class PublisherIntegrationPackBulkResponse(BaseModel):
    """PublisherIntegrationPackBulkResponse

    :param response: response, defaults to None
    :type response: List[PublisherIntegrationPackBulkResponseResponse], optional
    """

    def __init__(
        self,
        response: List[PublisherIntegrationPackBulkResponseResponse] = SENTINEL,
        **kwargs,
    ):
        """PublisherIntegrationPackBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(
                response, PublisherIntegrationPackBulkResponseResponse
            )
        self._kwargs = kwargs
