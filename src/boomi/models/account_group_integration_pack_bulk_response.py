...
from .account_group_integration_pack import AccountGroupIntegrationPack
...
@JsonMap({})
class AccountGroupIntegrationPackBulkResponse(BaseModel):
    """AccountGroupIntegrationPackBulkResponse

    :param response: response, defaults to None
    :type response: List[AccountGroupIntegrationPackBulkResponseResponse], optional
    """

    def __init__(
        self,
        response: List[AccountGroupIntegrationPackBulkResponseResponse] = SENTINEL,
        **kwargs,
    ):
        """AccountGroupIntegrationPackBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(
                response, AccountGroupIntegrationPackBulkResponseResponse
            )
        self._kwargs = kwargs
