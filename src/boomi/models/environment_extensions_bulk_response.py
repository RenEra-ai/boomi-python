...
class EnvironmentExtensionsBulkResponseResponse(BaseModel):
    """EnvironmentExtensionsBulkResponseResponse

    :param result: result, defaults to None
    :type result: EnvironmentExtensions, optional
    ...
    def __init__(
        self,
        result: EnvironmentExtensions = SENTINEL,
        index: int = SENTINEL,
        id_: str = SENTINEL,
        ...
        **kwargs,
        ...
        if result is not SENTINEL:
            self.result = self._define_object(result, EnvironmentExtensions)
...
@JsonMap({})
class EnvironmentExtensionsBulkResponse(BaseModel):
    """EnvironmentExtensionsBulkResponse

    :param response: response, defaults to None
    :type response: List[EnvironmentExtensionsBulkResponseResponse], optional
    """

    def __init__(
        self,
        response: List[EnvironmentExtensionsBulkResponseResponse] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentExtensionsBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(
                response, EnvironmentExtensionsBulkResponseResponse
            )
        self._kwargs = kwargs
