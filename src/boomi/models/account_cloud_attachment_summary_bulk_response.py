...
@JsonMap({})
class AccountCloudAttachmentSummaryBulkResponse(BaseModel):
    """AccountCloudAttachmentSummaryBulkResponse

    :param response: response, defaults to None
    :type response: List[AccountCloudAttachmentSummaryBulkResponseResponse], optional
    """

    def __init__(self, response: List[AccountCloudAttachmentSummaryBulkResponseResponse] = SENTINEL, **kwargs):
        """AccountCloudAttachmentSummaryBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(response, AccountCloudAttachmentSummaryBulkResponseResponse)
        self._kwargs = kwargs
