...
class EnvironmentMapExtensionBulkResponseResponse(BaseModel):
    """EnvironmentMapExtensionBulkResponseResponse

    :param result: result, defaults to None
    :type result: EnvironmentMapExtension, optional
    ...
    def __init__(
        self,
        result: EnvironmentMapExtension = SENTINEL,
        index: int = SENTINEL,
        id_: str = SENTINEL,
        ...
        **kwargs,
        ...
        if result is not SENTINEL:
            self.result = self._define_object(result, EnvironmentMapExtension)
...
@JsonMap({})
class EnvironmentMapExtensionBulkResponse(BaseModel):
    """EnvironmentMapExtensionBulkResponse

    :param response: response, defaults to None
    :type response: List[EnvironmentMapExtensionBulkResponseResponse], optional
    """

    def __init__(
        self,
        response: List[EnvironmentMapExtensionBulkResponseResponse] = SENTINEL,
        **kwargs,
    ):
        """EnvironmentMapExtensionBulkResponse
        ...
        if response is not SENTINEL:
            self.response = self._define_list(
                response, EnvironmentMapExtensionBulkResponseResponse
            )
        self._kwargs = kwargs
